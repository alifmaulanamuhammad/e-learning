...
CREATE DATABASE IF NOT EXISTS `edu_core` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `edu_core`;
...
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  `course_type` enum('course') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'course',
  ...
  `demo_video_storage` enum('upload','youtube','vimeo','external_link') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `demo_video_source` text COLLATE utf8mb4_general_ci,
  ...
  `message_for_reviewer` text COLLATE utf8mb4_general_ci,
  `is_approved` enum('pending','approved','rejected') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `course_chapter_lessions` (
  ...
  `storage` enum('upload','youtube','vimeo','external_link') COLLATE utf8mb4_general_ci NOT NULL,
  `volume` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `duration` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `file_type` enum('video','audio','doc','file') COLLATE utf8mb4_general_ci NOT NULL,
  `downloadable` tinyint(1) NOT NULL DEFAULT '0',
  `order` int NOT NULL,
  `is_preview` tinyint(1) NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `lesson_type` enum('lesson','live') COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `role` enum('instructor','student') COLLATE utf8mb4_general_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '/default-files/avatar.png',
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `approve_status` enum('pending','approved','rejected') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `login_as` enum('student','instructor') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
